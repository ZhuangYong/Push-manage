...
webpackJsonp([36], { IYL0: function IYL0(t, e, n) {
    ...
    var a = function a() {
      var t = this,
          ...
          n = t._self._c || e;return n("div", { staticClass: "app-container" }, [n("el-button", { staticStyle: { "margin-bottom": "20px" }, attrs: { type: "primary", icon: "document", loading: t.downloadLoading }, on: { click: t.handleDownload } }, [t._v("导出excel")]), t._v(" "), n("el-table", { directives: [{ name: "loading", rawName: "v-loading.body", value: t.listLoading, expression: "listLoading", modifiers: { body: !0 } }], attrs: { data: t.list, "element-loading-text": "拼命加载中", border: "", fit: "", "highlight-current-row": "" } }, [n("el-table-column", { attrs: { align: "center", label: "ID", width: "95" }, scopedSlots: t._u([{ key: "default", fn: function fn(e) {
            ...
            return [n("i", { staticClass: "el-icon-time" }), t._v(" "), n("span", [t._v(t._s(t._f("parseTime")(e.row.timestamp, "{y}-{m}-{d} {h}:{i}")))])];
          } }]) })], 1)], 1);
    },
        i = [],
    ...
    var a = n("viA7"),
        ...
        this.fetchData();
          ...
          var t = this;this.downloadLoading = !0, _promise2.default.all([n.e(53), n.e(54)]).then(function () {
            var e = n("zWO4"),
                a = e.export_json_to_excel,
                i = ["序号", "文章标题", "作者", "阅读数", "发布时间"],
                l = ["id", "title", "author", "pageviews", "display_time"],
                o = t.list;a(i, t.formatJson(l, o), "列表excel"), t.downloadLoading = !1;
          }.bind(null, n)).catch(n.oe);
        }, formatJson: function formatJson(t, e) {
          return e.map(function (e) {
            return t.map(function (t) {
              return "timestamp" === t ? n.i(i.b)(e[t]) : e[t];
            });
          });
        } } };
...
//# sourceMappingURL=36.b745fb04bb3bafc55171.js.map