...
webpackJsonp([6], { "7X2j": function X2j(e, i, t) {
    ...
    var a = t("fZjL"),
        ...
        c = t("Vo7i"),
        n = t("pbS8"),
        l = { jpg: "image/jpeg", png: "image/png", gif: "image/gif", svg: "image/svg+xml", psd: "image/photoshop" };i.a = { props: { field: { type: String, default: "avatar" }, url: { type: String, default: "" }, params: { type: Object, default: null }, width: { type: Number, default: 200 }, height: { type: Number, default: 200 }, noCircle: { type: Boolean, default: !1 }, maxSize: { type: Number, default: 10240 }, langType: { type: String, default: "zh" } }, data: function data() {
        var e = this,
            i = e.langType,
            t = e.width,
            a = e.height,
            o = !0,
            r = n.a[i] ? n.a[i] : r.zh;return "function" != typeof FormData && (o = !1), { show: !0, mime: l.jpg, lang: r, isSupported: o, step: 1, loading: 0, progress: 0, hasError: !1, errorMsg: "", ratio: t / a, sourceImg: null, sourceImgUrl: "", createImgUrl: "", sourceImgMouseDown: { on: !1, mX: 0, mY: 0, x: 0, y: 0 }, previewContainer: { width: 100, height: 100 }, sourceImgContainer: { width: 240, height: 180 }, scale: { zoomAddOn: !1, zoomSubOn: !1, range: 1, x: 0, y: 0, width: 0, height: 0, maxWidth: 0, maxHeight: 0, minWidth: 0, minHeight: 0, naturalWidth: 0, naturalHeight: 0 } };
      }, computed: { progressStyle: function progressStyle() {
          return { width: this.progress + "%" };
        }, sourceImgStyle: function sourceImgStyle() {
          var e = this.scale,
              i = this.sourceImgMasking;return { top: e.y + i.y + "px", left: e.x + i.x + "px", width: e.width + "px", height: e.height + "px" };
          ...
          var e = this.width,
              ...
              c = o.width,
              n = o.height,
              l = 1;return t < r && (l = o.height / i, c = o.height * t, p = (o.width - c) / 2), t > r && (l = o.width / e, n = o.width / t, s = (o.height - n) / 2), { scale: l, x: p, y: s, width: c, height: n };
        }, sourceImgShadeStyle: function sourceImgShadeStyle() {
          var e = this.sourceImgContainer,
              i = this.sourceImgMasking;return { width: (i.width == e.width ? i.width : (e.width - i.width) / 2) + "px", height: (i.height == e.height ? i.height : (e.height - i.height) / 2) + "px" };
        }, previewStyle: function previewStyle() {
          var e = (this.width, this.height, this.ratio),
              i = this.previewContainer,
              t = i,
              a = t.width,
              o = t.height,
              r = a / o;return e < r && (a = t.height * e), e > r && (o = t.width / e), { width: a + "px", height: o + "px" };
        } }, methods: { ripple: function ripple(e) {
          t.i(s.a)(e);
        }, off: function off() {
          ...
          if (e.preventDefault(), 1 !== this.loading) {
            var i = e.target.files || e.dataTransfer.files;this.reset(), this.checkFile(i[0]) && this.setSourceImg(i[0]);
          }
        }, checkFile: function checkFile(e) {
          var i = this,
              t = i.lang,
              a = i.maxSize;return -1 === e.type.indexOf("image") ? (i.hasError = !0, i.errorMsg = t.error.onlyImg, !1) : (this.mime = e.type, !(e.size / 1024 > a) || (i.hasError = !0, i.errorMsg = t.error.outOfSize + a + "kb", !1));
        }, reset: function reset() {
          var e = this;e.step = 1, e.loading = 0, e.hasError = !1, e.errorMsg = "", e.progress = 0;
        }, setSourceImg: function setSourceImg(e) {
          var i = this,
              t = new FileReader();t.onload = function (e) {
            i.sourceImgUrl = t.result, i.startCrop();
          }, t.readAsDataURL(e);
        }, startCrop: function startCrop() {
          var e = this,
              i = (e.width, e.height, e.ratio),
              t = e.scale,
              a = e.sourceImgUrl,
              o = e.sourceImgMasking,
              r = (e.lang, o),
              p = new Image();p.src = a, p.onload = function () {
            var a = p.naturalWidth,
                o = p.naturalHeight,
                s = a / o,
                c = r.width,
                n = r.height,
                l = 0,
                v = 0;i > s && (n = c / s, v = (r.height - n) / 2), i < s && (c = n * s, l = (r.width - c) / 2), t.range = 0, t.x = l, t.y = v, t.width = c, t.height = n, t.minWidth = c, t.minHeight = n, t.maxWidth = a * r.scale, t.maxHeight = o * r.scale, t.naturalWidth = a, t.naturalHeight = o, e.sourceImg = p, e.createImg(), e.setStep(2);
          };
        }, imgStartMove: function imgStartMove(e) {
          var i = this.sourceImgMouseDown,
              t = this.scale,
              a = i;a.mX = e.screenX, a.mY = e.screenY, a.x = t.x, a.y = t.y, a.on = !0;
          ...
          var i = this.sourceImgMouseDown,
              ...
              g = v - o,
              u = r + d,
              h = p + g;t && (u > 0 && (u = 0), h > 0 && (h = 0), u < n.width - s.width && (u = n.width - s.width), h < n.height - s.height && (h = n.height - s.height), s.x = u, s.y = h);
        }, startZoomAdd: function startZoomAdd(e) {
          function i() {
            if (a.zoomAddOn) {
              var e = a.range >= 100 ? 100 : ++a.range;t.zoomImg(e), setTimeout(function () {
                i();
              }, 60);
            }
          }var t = this,
              a = t.scale;a.zoomAddOn = !0, i();
        }, endZoomAdd: function endZoomAdd(e) {
          this.scale.zoomAddOn = !1;
        }, startZoomSub: function startZoomSub(e) {
          function i() {
            if (a.zoomSubOn) {
              var e = a.range <= 0 ? 0 : --a.range;t.zoomImg(e), setTimeout(function () {
                i();
              }, 60);
            }
          }var t = this,
              a = t.scale;a.zoomSubOn = !0, i();
          ...
          var i = this,
              ...
              a = (this.sourceImgMouseDown, this.scale),
              o = a.maxWidth,
              r = a.maxHeight,
              p = a.minWidth,
              s = a.minHeight,
              ...
              m = s + (r - s) * e / 100,
              f = g / 2 - h / c * (g / 2 - l),
              w = u / 2 - m / n * (u / 2 - v);f > 0 && (f = 0), w > 0 && (w = 0), f < g - h && (f = g - h), w < u - m && (w = u - m), a.x = f, a.y = w, a.width = h, a.height = m, a.range = e, setTimeout(function () {
            a.range == e && i.createImg();
          }, 300);
          ...
          var i = this,
              ...
              s = o.width,
              c = o.height,
              n = i.sourceImgMasking.scale,
              l = i.$refs.canvas,
              v = l.getContext("2d");e && (i.sourceImgMouseDown.on = !1), v.drawImage(a, r / n, p / n, s / n, c / n), i.createImgUrl = l.toDataURL(t);
          ...
          var e = this,
              ...
              n = this.url,
              l = this.params,
              v = (this.headers, this.field),
              d = this.ki,
              g = this.createImgUrl,
              u = new FormData();u.append(v, t.i(s.b)(g, r), v + "." + a), "object" == (void 0 === l ? "undefined" : p()(l)) && l && o()(l).forEach(function (e) {
            u.append(e, l[e]);
          }), e.reset(), e.loading = 1, e.setStep(3), e.$emit("crop-success", g, v, d), t.i(c.a)({ url: n, method: "post", data: u }).then(function (i) {
            e.loading = 2, e.$emit("crop-upload-success", i.data);
          }).catch(function (t) {
            e.value && (e.loading = 3, e.hasError = !0, e.errorMsg = i.fail, e.$emit("crop-upload-fail", t, v, d));
          });
        } } };
  }, OBQn: function OBQn(e, i, t) {
    "use strict";

    var a = t("Oakg"),
        o = t("kCe2");i.a = { components: { ImageCropper: a.a, PanThumb: o.a }, data: function data() {
        return { imagecropperShow: !1, imagecropperKey: 0, image: "https://wpimg.wallstcn.com/577965b9-bb9e-4e02-9f0c-095b41417191" };
      }, methods: { cropSuccess: function cropSuccess(e) {
          this.imagecropperShow = !1, this.imagecropperKey = this.imagecropperKey + 1, this.image = e.files.avatar;
        }, close: function close() {
          this.imagecropperShow = !1;
        } } };
  }, Oakg: function Oakg(e, i, t) {
    "use strict";
