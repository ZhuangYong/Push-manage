...
webpackJsonp([0, 2, 11, 42, 43, 44], { "+NFJ": function NFJ(t, e, a) {
    ...
    var o = a("mvHQ"),
        ...
        return { visibility: "all", filters: r, todos: JSON.parse(window.localStorage.getItem("todos")) || s };
          ...
          window.localStorage.setItem("todos", i()(this.todos));
          ...
          var e = t.todo,
              a = t.value;e.text = a, this.setLocalStorgae();
          ...
          var e = this,
              a = t.done;this.todos.forEach(function (t) {
            t.done = a, e.setLocalStorgae();
          });
    ...
    function o(t) {
      a("ARbI");
        ...
        r = a("VU/8"),
        s = o,
        l = r(i.a, n.a, s, "data-v-3517b695", null);e.default = l.exports;
  }, "4D5Q": function D5Q(t, e, a) {
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("div", { staticClass: "dashboard-container" }, [a(t.currentRole, { tag: "component" })], 1);
    },
        i = [],
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("div", { staticClass: "dashboard-editor-container" }, [a("div", { staticClass: " clearfix" }, [a("pan-thumb", { staticStyle: { float: "left" }, attrs: { image: t.avatar } }, [t._v(" 你的权限:\n      "), t._l(t.roles, function (e) {
        return a("span", { key: e, staticClass: "pan-info-roles" }, [t._v(t._s(e))]);
      })], 2), t._v(" "), a("github"), t._v(" "), a("div", { staticClass: "info-container" }, [a("span", { staticClass: "display_name" }, [t._v(t._s(t.name))]), t._v(" "), a("span", { staticStyle: { "font-size": "20px", "padding-top": "20px", display: "inline-block" } }, [t._v("普通编辑dashboard")])])], 1), t._v(" "), a("div", [a("img", { staticClass: "emptyGif", attrs: { src: t.emptyGif } })])]);
    },
        i = [],
        n = { render: o, staticRenderFns: i };e.a = n;
    ...
    var o = a("Dd8w"),
        ...
        p = a("IKLf"),
        u = a("TyIG"),
        h = a("jrCs");e.a = { name: "dashboard-admin", components: { countTo: s.a, panThumb: l.a, todoList: d.a, Github: c.a, pieChart: p.default, lineChart: h.default, barChart: u.default }, data: function data() {
    ...
    var o = a("Dd8w"),
        ...
        n = a("NYxO"),
        r = a("kCe2"),
        s = a("woPf");e.a = { name: "dashboard-editor", components: { PanThumb: r.a, Github: s.a }, data: function data() {
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("div", { staticClass: "pan-item", style: { zIndex: t.zIndex, height: t.height, width: t.width } }, [a("div", { staticClass: "pan-info" }, [a("div", { staticClass: "pan-info-roles-container" }, [t._t("default")], 2)]), t._v(" "), a("img", { staticClass: "pan-thumb", attrs: { src: t.image } })]);
    },
        i = [],
        n = { render: o, staticRenderFns: i };e.a = n;
    ...
    !function (e, a) {
      ...
      return function (t) {
        function e(o) {
          if (a[o]) return a[o].exports;var i = a[o] = { i: o, l: !1, exports: {} };return t[o].call(i.exports, i, i.exports, e), i.l = !0, i.exports;
        }var a = {};return e.m = t, e.c = a, e.i = function (t) {
          return t;
        }, e.d = function (t, a, o) {
          e.o(t, a) || (0, _defineProperty2.default)(t, a, { configurable: !1, enumerable: !0, get: o });
        }, e.n = function (t) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 });var o = a(2);e.default = { props: { startVal: { type: Number, required: !1, default: 0 }, endVal: { type: Number, required: !1, default: 2017 }, duration: { type: Number, required: !1, default: 3e3 }, autoplay: { type: Boolean, required: !1, default: !0 }, decimals: { type: Number, required: !1, default: 0, validator: function validator(t) {
                ...
                return a * (1 - Math.pow(2, -10 * t / o)) * 1024 / 1023 + e;
              } } }, data: function data() {
            ...
            this.autoplay && this.start(), this.$emit("mountedCallback");
              ...
              this.localStartVal = this.startVal, this.startTime = null, this.localDuration = this.duration, this.paused = !1, this.rAF = (0, o.requestAnimationFrame)(this.count);
            }, pauseResume: function pauseResume() {
              this.paused ? (this.resume(), this.paused = !1) : (this.pause(), this.paused = !0);
            }, pause: function pause() {
              (0, o.cancelAnimationFrame)(this.rAF);
            }, resume: function resume() {
              this.startTime = null, this.localDuration = +this.remaining, this.localStartVal = +this.printVal, (0, o.requestAnimationFrame)(this.count);
            }, reset: function reset() {
              this.startTime = null, (0, o.cancelAnimationFrame)(this.rAF), this.displayValue = this.formatNumber(this.startVal);
              ...
              t = t.toFixed(this.decimals), t += "";var e = t.split("."),
                  a = e[0],
                  o = e.length > 1 ? this.decimal + e[1] : "",
                  i = /(\d+)(\d{3})/;if (this.separator && !this.isNumber(this.separator)) for (; i.test(a);) {
                a = a.replace(i, "$1" + this.separator + "$2");
              }return this.prefix + a + o + this.suffix;
        ...
        t.exports = function (t, e, a, o) {
          var i,
              n = t = t || {},
              r = (0, _typeof3.default)(t.default);"object" !== r && "function" !== r || (i = t, n = t.default);var s = "function" == typeof n ? n.options : n;if (e && (s.render = e.render, s.staticRenderFns = e.staticRenderFns), a && (s._scopeId = a), o) {
            var l = (0, _create2.default)(s.computed || null);(0, _keys2.default)(o).forEach(function (t) {
              var e = o[t];l[t] = function () {
                return e;
              };
            }), s.computed = l;
        ...
        }(o);e.default = i.default, "undefined" != typeof window && window.Vue && window.Vue.component("count-to", i.default);
      }]);
    });
  }, WFoK: function WFoK(t, e, a) {
    var o = a("pCEm");"string" == typeof o && (o = [[t.i, o, ""]]), o.locals && (t.exports = o.locals);a("rjj0")("7384657b", o, !0);
  }, Zbun: function Zbun(t, e, a) {
    var o = a("iANj"),
        i = o.JSON || (o.JSON = { stringify: _stringify2.default });t.exports = function (t) {
      return i.stringify.apply(i, arguments);
    };
  }, aFvj: function aFvj(t, e, a) {
    ...
    var o = a("XLwt"),
        ...
        var t = this;this.initChart(), this.autoResize && (this.__resizeHanlder = a.i(n.c)(function () {
    ...
    var o = a("Dd8w"),
        ...
        n = a("NYxO"),
        r = a("1Rx3"),
        s = a("DY7s");e.a = { name: "dashboard", components: { adminDashboard: r.default, editorDashboard: s.default }, data: function data() {
        return { currentRole: "adminDashboard" };
      }, computed: i()({}, a.i(n.b)(["roles"])), created: function created() {
        this.roles.indexOf("admin") >= 0 || (this.currentRole = "editorDashboard");
      } };
  }, c05m: function c05m(t, e, a) {
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("section", { staticClass: "todoapp" }, [a("header", { staticClass: "header" }, [a("input", { staticClass: "new-todo", attrs: { autofocus: "", autocomplete: "off", placeholder: "TODO LIST?" }, on: { keyup: function keyup(e) {
            if (!("button" in e) && t._k(e.keyCode, "enter", 13)) return null;t.addTodo(e);
          } } })]), t._v(" "), a("section", { directives: [{ name: "show", rawName: "v-show", value: t.todos.length, expression: "todos.length" }], staticClass: "main" }, [a("input", { staticClass: "toggle-all", attrs: { id: "toggle-all", type: "checkbox" }, domProps: { checked: t.allChecked }, on: { change: function change(e) {
            t.toggleAll({ done: !t.allChecked });
          } } }), t._v(" "), a("label", { attrs: { for: "toggle-all" } }), t._v(" "), a("ul", { staticClass: "todo-list" }, t._l(t.filteredTodos, function (e, o) {
        return a("todo", { key: o, attrs: { todo: e }, on: { toggleTodo: t.toggleTodo, editTodo: t.editTodo, deleteTodo: t.deleteTodo } });
      }))]), t._v(" "), a("footer", { directives: [{ name: "show", rawName: "v-show", value: t.todos.length, expression: "todos.length" }], staticClass: "footer" }, [a("span", { staticClass: "todo-count" }, [a("strong", [t._v(t._s(t.remaining))]), t._v("\n      " + t._s(t._f("pluralize")(t.remaining, "item")) + " left\n    ")]), t._v(" "), a("ul", { staticClass: "filters" }, t._l(t.filters, function (e, o) {
        return a("li", { key: o }, [a("a", { class: { selected: t.visibility === o }, on: { click: function click(e) {
              e.preventDefault(), t.visibility = o;
            } } }, [t._v(t._s(t._f("capitalize")(o)))])]);
      })), t._v(" "), a("button", { directives: [{ name: "show", rawName: "v-show", value: t.todos.length > t.remaining, expression: "todos.length > remaining" }], staticClass: "clear-completed", on: { click: t.clearCompleted } }, [t._v("\n      Clear completed\n    ")])])]);
    },
        i = [],
        n = { render: o, staticRenderFns: i };e.a = n;
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("div", { staticClass: "dashboard-editor-container" }, [a("github"), t._v(" "), a("el-row", { staticClass: "btn-group" }, [a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn blue-btn", attrs: { to: "/components/index" } }, [t._v("Components")])], 1), t._v(" "), a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn light-blue-btn", attrs: { to: "/charts/index" } }, [t._v("Charts")])], 1), t._v(" "), a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn pink-btn", attrs: { to: "/excel/download" } }, [t._v("Excel")])], 1), t._v(" "), a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn green-btn", attrs: { to: "/example/table/table" } }, [t._v("Table")])], 1), t._v(" "), a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn tiffany-btn", attrs: { to: "/example/form/edit" } }, [t._v("Form")])], 1), t._v(" "), a("el-col", { staticClass: "text-center", attrs: { span: 4 } }, [a("router-link", { staticClass: "pan-btn yellow-btn", attrs: { to: "/theme/index" } }, [t._v("Theme")])], 1)], 1), t._v(" "), a("el-row", [a("el-col", { attrs: { span: 6 } }, [a("el-card", { staticClass: "box-card" }, [a("div", { staticClass: "box-card-header", slot: "header" }, [a("pan-thumb", { staticClass: "panThumb", attrs: { image: t.avatar } }, [t._v(" 你的权限:\n\t\t\t\t\t\t"), t._l(t.roles, function (e) {
        return a("span", { key: e, staticClass: "pan-info-roles" }, [t._v(t._s(e))]);
      })], 2)], 1), t._v(" "), a("span", { staticClass: "display_name" }, [t._v(t._s(t.name))]), t._v(" "), a("div", { staticClass: "info-item" }, [a("count-to", { staticClass: "info-item-num", attrs: { startVal: 0, endVal: t.statisticsData.article_count, duration: 3400 } }), t._v(" "), a("span", { staticClass: "info-item-text" }, [t._v("文章")]), t._v(" "), a("icon-svg", { staticClass: "dashboard-editor-icon", attrs: { "icon-class": "trendChart1" } })], 1), t._v(" "), a("div", { staticClass: "info-item" }, [a("count-to", { staticClass: "info-item-num", attrs: { startVal: 0, endVal: t.statisticsData.pageviews_count, duration: 3600 } }), t._v(" "), a("span", { staticClass: "info-item-text" }, [t._v("浏览量")]), t._v(" "), a("icon-svg", { staticClass: "dashboard-editor-icon", attrs: { "icon-class": "trendChart2" } })], 1)])], 1), t._v(" "), a("el-col", { attrs: { span: 8 } }, [a("pie-chart")], 1), t._v(" "), a("el-col", { attrs: { span: 10 } }, [a("bar-chart")], 1)], 1), t._v(" "), a("el-row", { attrs: { gutter: 20 } }, [a("el-col", { attrs: { span: 15 } }, [a("line-chart")], 1), t._v(" "), a("el-col", { attrs: { span: 9 } }, [a("todo-list")], 1)], 1)], 1);
    },
        i = [],
        n = { render: o, staticRenderFns: i };e.a = n;
  }, mvHQ: function mvHQ(t, e, a) {
    t.exports = { default: a("Zbun"), __esModule: !0 };
  }, pCEm: function pCEm(t, e, a) {
    ...
    e.a = { name: "Todo", props: ["todo"], data: function data() {
        return { editing: !1 };
          ...
          var o = e.value,
              i = a.context;o && i.$nextTick(function () {
            t.focus();
          });
          ...
          var e = t.todo,
              a = t.value;this.$emit("editTodo", { todo: e, value: a });
        }, toggleTodo: function toggleTodo(t) {
          this.$emit("toggleTodo", t);
        }, doneEdit: function doneEdit(t) {
          var e = t.target.value.trim(),
              a = this.todo;e ? this.editing && (this.editTodo({ todo: a, value: e }), this.editing = !1) : this.deleteTodo({ todo: a });
    ...
    var o = function o() {
      var t = this,
          e = t.$createElement,
          a = t._self._c || e;return a("li", { staticClass: "todo", class: { completed: t.todo.done, editing: t.editing } }, [a("div", { staticClass: "view" }, [a("input", { staticClass: "toggle", attrs: { type: "checkbox" }, domProps: { checked: t.todo.done }, on: { change: function change(e) {
            t.toggleTodo(t.todo);
          } } }), t._v(" "), a("label", { domProps: { textContent: t._s(t.todo.text) }, on: { dblclick: function dblclick(e) {
            t.editing = !0;
          } } }), t._v(" "), a("button", { staticClass: "destroy", on: { click: function click(e) {
            t.deleteTodo(t.todo);
          } } })]), t._v(" "), a("input", { directives: [{ name: "show", rawName: "v-show", value: t.editing, expression: "editing" }, { name: "focus", rawName: "v-focus", value: t.editing, expression: "editing" }], staticClass: "edit", domProps: { value: t.todo.text }, on: { keyup: [function (e) {
...
//# sourceMappingURL=0.aa6f34ab5fb269180602.js.map