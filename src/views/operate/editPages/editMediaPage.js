...
export default class EditMediaPage extends BasePage {
    ...
    render() {
        ...
        return (
            <JPanel title={`${this.formData.id ? "修改" : "添加"}歌曲`}>
                    <el-form class="small-space" model={this.formData} ref="addForm" rules={this.validateRule} label-position="right" label-width="190px">
                    ...
                    <el-form-item label="是否免费：">
                        <el-radio-group value={this.formData.charge} name='charge'>
                            <el-radio value={-1024} label={-1024}>免费</el-radio>
