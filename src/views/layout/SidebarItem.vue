    ...
    <div class='menu-wrapper'>
        <template v-for="item in routes">
            ...
            <router-link v-if="!item.hidden&&item.noDropdown&&item.children.length>0"
                ...
                <el-menu-item :index="item.path+'/'+item.children[0].path" class='submenu-title-noDropdown' @click="handelLinkClick">
            ...
            <el-submenu :index="item.name" v-if="!item.noDropdown&&!item.hidden">
                ...
                <template v-for="child in item.children" v-if='!child.hidden'>
                    ...
                    <router-link v-else :to="item.path+'/'+child.path" :append="true">
                        <el-menu-item :index="item.path+'/'+child.path" @click="handelLinkClick">
