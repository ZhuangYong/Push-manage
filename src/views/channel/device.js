...
import {edit as changeDevice, del as delItemFun} from '../../api/device';
...
export default BaseListView.extend({
    ...
    data() {
        return {
            viewRule: [
                {columnKey: 'groupName', label: '分组名称', minWidth: 70},
                {columnKey: 'codeAutoDay', label: '邀请码自动分配天数', minWidth: 190},
                ...
                if (valid) {
                    ...
                    this.$refs.upload.handleStart({
                        success: r => {
                            ...
                            changeDevice(this.formData).then(res => {
                                this.$message({
                                    message: "操作成功",
                                    type: "success"
                                });
